...
class TransferReduceInventoryTest {
	@Mock
	...
	@InjectMocks
	private TransferReduceInventory engine;
	...
	void executeThrowsExceptionWhenNotEnoughInventory() {
		...
		assertThrows(InvalidInventoryTransferenceException.class, () -> engine.execute(items, shrinkageItems, 1L));
	}
