...
class CustomDateMXSerializerTest {

	@InjectMocks
	private CustomDateMXSerializer serializer;
	...
	void serializeWorksAsExpected() throws Exception {
		...
		assertThat(jsonWriter.toString(), is("\"01/12/2021 15:00\""));
	}

	@Test
	void defaultConstructorWorks() {
		CustomDateMXSerializer subject = new CustomDateMXSerializer();
